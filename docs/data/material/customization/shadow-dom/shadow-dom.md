...
Material UI components like Menu, Dialog, Popover, and others use a portal component to render a new "subtree" in a container outside of current DOM hierarchy.
